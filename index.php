...
if (isLoggedIn()) {
    redirect('dashboard.php'); // later te maken
}
?>
<!DOCTYPE html>
<html lang="nl">
<head>
    ...
    <title>La Vida Loca — Maffia Browser Game</title>
    <link rel="stylesheet" href="assets/css/style.css">
</head>
<body class="landing">

<header class="topbar">
    <div class="logo">LA VIDA <span>LOCA</span></div>
    <nav>
...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <p>Bouw je imperium op, rekruteer bendeleden, verdien geld en klim van straatveger tot godfather. Welkom in La Vida Loca.</p>
...
<footer class="footer">
    <p>&copy; <?= date('Y') ?> La Vida Loca. Alle rechten voorbehouden.</p>
</footer>
